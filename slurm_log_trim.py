...
# FULL_LOG_PATH = '~/rds/rds-dsk-lab-eWkDxBhxBrQ/dimorl/code/dogo_results/mopo/ray_mopo/full_logs'

# def main():
#     for path in glob('~/rds/rds-dsk-lab-eWkDxBhxBrQ/dimorl/code/dogo_results/mopo/ray_mopo/halfcheetah/*/seed*/train-log.*'):
