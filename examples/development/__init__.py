...
def get_params_from_file(
	...
	if dataset is not None:
		params['kwargs']['pool_load_path'] = f'/home/ajc348/rds/rds-dsk-lab-eWkDxBhxBrQ/dimorl/code/dogo_results/data/{dataset}.npy'
	...
	if dynamics_model_exp is not None:
		...
		params['kwargs']['model_load_dir'] = f'/home/ajc348/rds/rds-dsk-lab-eWkDxBhxBrQ/dimorl/code/dogo_results/mopo/ray_mopo/{load_exp_details["environment"]}/{load_exp_details["base_dir"]}/{load_exp_details["experiment_dir"]}/models'
