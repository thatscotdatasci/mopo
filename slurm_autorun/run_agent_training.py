...
SLURM_TRAIN_TEMPLATE_PATH = 'train.slurm.wilkes2.j2' #'train.slurm.peta4-icelake.j2'
...
if __name__ == '__main__':
    ...
    params_filepath = os.path.expanduser("~/rds/rds-dsk-lab-eWkDxBhxBrQ/dimorl/code/mopo/slurm_autorun/exp_params/W-MIXED-RT-5_bnn_r5_params.json")
